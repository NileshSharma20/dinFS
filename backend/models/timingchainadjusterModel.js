...
const timingchainadjusterSchema = mongoose.Schema({
    itemCode:{
        type: String,
...
module.exports = mongoose.model('Timingchainadjuster', timingchainadjusterSchema)