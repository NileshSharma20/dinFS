...
const mastercylinderassemblySchema = mongoose.Schema({
    itemCode:{
        type: String,
    ...
    productName:{
        type: String,
        default: "MASTER-CYLINDER-ASSEMBLY",
    },  
    vehicleModel:{
        type: String,
...
module.exports = mongoose.model('Mastercylinderassembly', mastercylinderassemblySchema)