...
const clutchgasketpackingSchema = mongoose.Schema({
    itemCode:{
        type: String,
...
module.exports = mongoose.model('Clutchgasketpacking', clutchgasketpackingSchema)